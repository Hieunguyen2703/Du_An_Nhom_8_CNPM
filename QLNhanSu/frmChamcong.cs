...
namespace QLNhanSu
{
    public partial class txbChamcong : Form
    {
        ...
        void LoadListCongBook()
        {
            dtgvCongBook.DataSource = null;
            CreateColumnForDataGridView();
            if (listCongBook.Instance.listCNV != null && listCongBook.Instance.listCNV.Count > 0)
            {
                dtgvCongBook.DataSource = listCongBook.Instance.listCNV; // Gán dữ liệu mới
            }
        ...
        DataTable CreateDataTable()
        {
            ...
            DataColumn colTinhTrang = new DataColumn("TinhTrang");
        ...
        void ReadXMLChamcong()
        {
            try
            {
                ...
                if (dataSetRead1.Tables.Count > 0)
                {
