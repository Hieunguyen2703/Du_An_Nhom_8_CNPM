namespace QLNhanSu.Properties
{
    public class listLuongNhanVien
    {
        ...
        private listLuongNhanVien()
        {
            ...
            listLuong.Add(new luongNhanVien("001201", "Nguyen Minh Hieu", 5.5f, 1000000f, 26, 500000f, 300000f));
            listLuong.Add(new luongNhanVien("001202", "Nguyen Duy Tuan", 3.5f, 1000000f, 26, 500000f, 300000f));
            listLuong.Add(new luongNhanVien("001203", "Nguyen Minh Tien", 2.5f, 1000000f, 27, 500000f, 300000f));
        }
