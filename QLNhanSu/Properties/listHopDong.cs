...
namespace QLNhanSu.Properties
{
    public class listHopDong
    {
        ...
        private listHopDong()
        {
            ...
            //ListHD.Add(new hopDongLaoDong("HD1", "001201", "2022-10-12", "2022-10-12", "2022-10-11"));
            //ListHD.Add(new hopDongLaoDong("HD2", "001202", "2022-11-12", "2022-11-12", "2022-11-11"));
            //ListHD.Add(new hopDongLaoDong("HD3", "001203", "2022-05-05", "2022-05-05", "2022-05-04"));
        }
