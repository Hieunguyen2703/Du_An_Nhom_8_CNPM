...
namespace QLNhanSu
{
    public class listDanhGia
    {
        ...
        private listDanhGia()
        {
            ...
            //danhSachDanhGia.Add(new danhGia("001201", "Nguyen Minh Hieu", "Khen thưởng", "500000", "Làm việc tích cực"));
            //danhSachDanhGia.Add(new danhGia("001202", "Nguyen Duy Tuan", " Kỷ luật", "500000", "Đi làm muộn"));
            //danhSachDanhGia.Add(new danhGia("001203", "Nguyen Minh Tien", "Khen thưởng", "500000", "Làm việc tích cực"));
